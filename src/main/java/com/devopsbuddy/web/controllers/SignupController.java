...
public class SignupController {
    ...
    // tells user username has already been taken
    public static final String DUPLICATED_USERNAME_KEY = "duplicatedUsername";

    // tells user email has already been taken
    public static final String DUPLICATED_EMAIL_KEY = "duplicatedEmail";

    // signals user that he has successfully signed up
    public static final String SIGNED_UP_MESSAGE_KEY = "signedUp";

    // identifies the model map key for the message we want to display to the user when things go wrong
